...

{
    ...
    // ambil data hasil submit dari form
            ...
            window.location.href="../../index_apoteker.php?page=pass&alert=1";
            </script>'; 
            ...
            window.location.href="../../index_apoteker.php?page=pass&alert=2";
            </script>'; 
                }
            ...
            window.location.href="../../index_apoteker.php?page=pass&alert=3";
            </script>'; 
                    }   
                }
            }
