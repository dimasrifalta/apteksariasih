      ...
      <table width="100%" border="0.3" cellpadding="0" cellspacing="0">
        <thead style="background:#e8ecee">
          <tr class="tr-title">
            ...
            <th height="20" align="center" valign="middle">Stok Obat</th>
            <th height="20" align="center" valign="middle">Karyawan</th>
    ...
    // jika data tidak ada
        ...
        while ($data = mysqli_fetch_assoc($query)) {
           ...
           // menampilkan isi tabel dari database ke tabel di aplikasi
                    ...
                    <td width='80' height='13' align='left' valign='middle'>$data[created_user]</td>
