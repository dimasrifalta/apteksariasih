    ...
    <div class="row">
      ...
      <div class="col-md-6 col-sm-6 col-xs-12">
        <div class="info-box border">
          ...
          <div class="info-box-content">
            <span class="info-box-text" >Total Data Obat Masuk Hari ini</span>
            <span class="info-box-number"> <?php $d1 = mysqli_query($config, "SELECT COUNT(kd_beli) as jumlah FROM pembelian
              where        tglpembelian=CURDATE()  ");
            $h1 = mysqli_fetch_array($d1);
            $total1 = number_format($h1['jumlah'],0,",",".");
            echo "$total1"; ?>  </span>
          </div>
    ...
    <div class="row">
      <div class="col-lg-3 col-xs-6">
        ...
        <div style="background-color:#00c0ef;color:#fff" class="small-box">
          ...
          <a href="<?php $_SERVER[SCRIPT_NAME];?>?page=obat1" class="small-box-footer" title="Lihat Data" data-toggle="tooltip"><i class="fa fa-plus"></i></a>
