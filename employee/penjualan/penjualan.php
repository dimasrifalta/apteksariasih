...
case 'view':
 ...
 <div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
      <i class="fa fa-file-text-o  icon-title"></i> Penjualan Obat Yang Kamu Lakukan
    ...
    <div class="row">
      ...
      <div class="col-md-2">
        <form action="<?php $_SERVER[SCRIPT_NAME];?>?page=cetak" method="POST" target="_blank">
          <label for="exampleInputEmail1"> Cetak Laporan Penjualan</label> <br>
            ...
            <div class="table-responsive">
              <table id="penjualan" class="table table-bordered table-striped table-hover">
                ...
                <tfoot>
                  ...
                  <th align = "center" colspan="5"> <span style="font-weight:bold">TOTAL</span></th>
                  <?php
...
$tampil = mysqli_query($config, "SELECT * FROM penjualan r
                          JOIN obat p ON ( r.kd_obat = p.kd_obat) where created_user='$user' AND
